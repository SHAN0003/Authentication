...
function Navbar() {
  const { user, logout } = useContext(AuthContext); // Fetch user & logout function

  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 rounded-3xl m-7">
            ...
            {user ? ( // Check if user is logged in
              <>
                <li>
                  <a
                    href="/"
                    className="block py-2 mt-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
                    aria-current="page"
                  >
                    Home
                  </a>
